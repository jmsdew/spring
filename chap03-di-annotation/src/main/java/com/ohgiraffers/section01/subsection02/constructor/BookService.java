...
/*@Service : @Component의 세분화 어노테이션의 한 종류로 Service 계층에서 사용한다.   (빈의 종류 중 하나)*/
@Service("bookSerivceConstructor")
public class BookService {

    private final BookDAO bookDAO;  // 필드 기반으로도 가능하지만 setter 기반이어야


    @Autowired  // 파라미터 부분을 보고 찾아줌     생성자 기반 AutoWired
    ...
    *   - '순환 참조' 에 대해 필드 주입 / 세터 주입 은 메소드 실행 시점에 오류가 발생한다.
