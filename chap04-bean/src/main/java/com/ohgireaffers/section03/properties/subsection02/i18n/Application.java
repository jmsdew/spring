package com.ohgireaffers.section03.properties.subsection02.i18n;
...
public class Application {
    public static void main(String[] args){
        ...
        /*
        * i18n 소프트웨어의 국제화 ( Internationalization 에서 첫글자인 i와 마지막 글자인 N 사이 알파벳 갯수가 18개)
        * (국제화 말고 현지화도 있음 (Localization : 현지화))
        * 어떤 프레임워클르 지칭하는 것이 아닌 i와 n 사이에 18개의 알파벳이라는 뜻이다.
